...
> This example requires a multi-device system (T3K, Galaxy, TT-QuietBox 2, or equivalent).
...
> Run on a multi-device system (T3K, Galaxy, TT-QuietBox 2) to execute this example.
