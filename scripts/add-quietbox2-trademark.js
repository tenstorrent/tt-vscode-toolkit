 ...
 *
 * Usage:
 *   node scripts/add-quietbox2-trademark.js          # apply
 *   node scripts/add-quietbox2-trademark.js --check  # exit 1 if any file needs update
 */
...
const MARK = 'QuietBox<sup>®</sup> 2';
const WORD_RE = /QuietBox 2(?!<sup>)/;
